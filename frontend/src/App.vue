  ...
  <div class="app-shell">
    <header class="app-header">
      ...
      <div class="header-meta">
        <button :class="['live-chip', { offline: !connected }]" aria-label="Przejdź do pulpitu" @click="activeTab = 'dashboard'"><i></i>{{ connected ? "LIVE" : "OFFLINE" }}</button>
...
.header-meta { margin-left:auto; display:flex; align-items:center; gap:12px; color:#d8dfec; font-size:15px; white-space:nowrap; }.live-chip{box-sizing:border-box;width:112px;height:35px;padding:0 13px;border:1px solid #007b42;color:#00f08a;background:transparent;display:flex;align-items:center;justify-content:center;gap:8px;border-radius:6px;font-size:14px;font-weight:600;cursor:pointer;}.live-chip:hover{background:rgba(0,240,138,.08)}.live-chip i{width:8px;height:8px;border-radius:50%;background:#00e77b}.live-chip.offline{color:#ff7380;border-color:#962a38}.live-chip.offline i{background:#ee3d52}
...
@media (max-width:700px){
  ...
  .header-meta{gap:6px}
  .live-chip,.alarm-button{width:84px;height:35px;padding:0;font-size:12px;gap:5px}
...
@media (max-width:359px){
  ...
  .live-chip,.alarm-button{width:78px;font-size:11px}
}
</style>
